...
namespace Synergy.ReliefCenter.Data.Repositories
{
    ...
    {
        public async Task<SalaryMatrix> GetSalaryMatrix(long vesselId, long seafarerId, string AuthToken)
        {
            using (var client = new HttpClient())
            {
                ...
                client.BaseAddress = new Uri("https://api-crew-wage-dev.synergymarinetest.com/");
